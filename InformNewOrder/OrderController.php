    ...
    <h1><b>Order List</b></h1>
         <div>
            <table style="width:30%; border: 3px solid maroon; " border="1">
              ...
              <br><button onclick="location.href='view.php'">Add Order</button><button onclick="location.href='DeleteController.php'">Delete Order</button><button onclick="location.href='ModelOrder.php'">Display List</button><br><br>
            <?php
            if($result) {
		        echo("Data inserted");
			}
